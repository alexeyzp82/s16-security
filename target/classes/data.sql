...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (5, 'Nick', 'Green', 'nick@mail.com', '$2a$12$N44cgXEIJORWG8WkMXv9eujMmghW..A/2.zxRIanKk4RSPjp8TBfi', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (6, 'Nora', 'White', 'nora@mail.com', '$2a$12$WUS.amqLkr2jvlOL6ONK5eK66AIwSOZuGmP5M1v6Wbxt9jsxE9JrO', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (4, 'Mike', 'Brown', 'mike@mail.com', '$2a$12$kIOpA6DOeW2IemQDJhhDyetM8BDlIkyr4NYm6xBedGXzfSvyXgZH2', 1);
